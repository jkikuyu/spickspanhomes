  ...
  <main-layout>
    ...
    >
      <div class="flex w-[calc(100vw-230px)]">
        <img :src="$profileStore.image" class="rounded-full max-w-[120px]" />
      ...
      <div class="w-full flex items-center pt-4 border-b">
        <div
          class="w-60 text-center text-[17px] font-semibold border-b-2 border-b-black"
        >
          Videos
        </div>
        <div
